...
import { PRODUCTIZED_OFFERS } from "./data/productizedOffers";
    ...
    <div>
      ...
      <section style={{ padding: "48px 0", borderTop: "1px solid #e5e7eb" }}>
        <div className="container">
          ...
          <p style={{ fontSize: "14px", color: "#6b7280", marginBottom: "24px", maxWidth: "720px", lineHeight: 1.7 }}>
            Fixed-fee consulting offers packaged from the products below. Each offer is 30-90 days,
            with proof points from production deployments.
          </p>
          <div style={{
            display: "grid",
        ...
        <div className="container">
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            {PRODUCTIZED_OFFERS.map((offer) => {
              const linkedProducts = offer.builtOn
              ...
              return (
                <div key={offer.id} style={{
                  ...
                  <div style={{ marginBottom: "20px" }}>
                    ...
                    <ul style={{ fontSize: "13px", color: "#374151", lineHeight: 1.7, paddingLeft: "20px", margin: 0 }}>
                  ...
                  <div style={{
                    ...
                    <ul style={{ fontSize: "13px", color: "#0c4a6e", lineHeight: 1.7, paddingLeft: "20px", margin: 0 }}>
                      {offer.proofPoints.map((p, i) => (
                        <li key={i}>{p}</li>
                      ))}
                    </ul>
                  </div>
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: "22px", fontWeight: 700, marginBottom: "12px", letterSpacing: "-0.01em" }}>
              Scoping a project?
            </h2>
